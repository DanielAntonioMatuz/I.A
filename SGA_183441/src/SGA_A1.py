...
# chromosomes
chromosome = np.zeros([popSize, genomeLength], dtype=np.int)
nchromosome = np.zeros([popSize, genomeLength], dtype=np.int)
poblacionAnterior = np.zeros([popSize, genomeLength], dtype=np.int)

child1 = np.zeros([popSize, genomeLength], dtype=np.int)
child2 = np.zeros([popSize, genomeLength], dtype=np.int)
